...
The interactive knowledge assessment contains **20 questions** selected and randomized in the browser. A minimum score of **80%** is required to pass the knowledge component.

> **Important:** The practical case study, CSM simulation, and process/documentation review remain evaluator-led activities. Passing the browser assessment alone does not constitute final VCCSP certification approval.
...
<div id="vccsp-progress" class="vccsp-progress" aria-live="polite" hidden></div>
...
<div id="vccsp-result" class="vccsp-result" aria-live="polite" hidden></div>
...
> **Certificate rule:** A digital certificate is generated only when the knowledge assessment reaches the 80% passing threshold. The generated certificate records the knowledge-assessment result and explicitly states that final VCCSP certification is subject to the remaining evaluator-led components.
...
- [ ] Can manage customer onboarding.
- [ ] Can conduct customer meetings.
- [ ] Can maintain CRM records.
- [ ] Can analyze customer health.
...
- A note that final VCCSP certification remains subject to the evaluator-led components

The certificate can be printed or saved as a PDF from the browser using **Print / Save Certificate**.

> **Certificate integrity note:** The certificate generated by this page confirms the browser-based knowledge assessment result. It does not represent final VCCSP certification until the practical case study, simulation, and process/documentation review are completed and approved.
