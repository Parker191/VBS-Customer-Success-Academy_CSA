...
Maps the [Health Scorecard Template](../Templates/Health%20Scorecard%20Template.md) fields to their corresponding Zoho CRM fields, so scores entered on paper/document are reflected consistently in CRM for reporting.
...
- `Health_Status` should auto-derive from the total using the RAG thresholds defined in the [Health Scorecard Template](../Templates/Health%20Scorecard%20Template.md) (28–35 Green, 18–27 Yellow, below 18 Red).
