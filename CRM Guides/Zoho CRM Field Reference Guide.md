...
A field-by-field reference for the Customer/Account record in Zoho CRM — what each field means, who owns updating it, and how often it should be reviewed. Use this alongside the [CRM Management SOP](../SOPs/CRM%20Management.md), which covers the step-by-step update process.
